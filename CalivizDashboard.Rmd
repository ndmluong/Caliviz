...
<h1>Caliviz - Outil interactif permettant la visualisation des substances chimiques auxquelles est exposée la population française via son alimentation</h1>

```{r webappheader, echo = F, out.width = '100%'}
knitr::include_graphics("www/fig/caliviz_bande.jpg")
```
...
<p style="color:#FF9940">*Dernière mise à jour: le 8 juillet 2023 à 6:00*</p>
