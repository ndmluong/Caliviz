...
ui_PS <- fluidPage(
  ...
  navbarPage(
    ...
    tabPanel("TDS 2",
             tabsetPanel(
               tabPanel("Significant presence",
                        fluidRow(
                          column(6,selectInput("eat2_multiple_food", "Food item(s)",
                        ...
                        fluidRow(
                          column(12, actionButton("btn_eat2_plot_check", "View", icon = icon("eye"), class = "btn-success"))
                        ),
                        fluidRow(
